...
**Files:** `src/utils/pdfExport.js` (PDF layout), `src/Components/CustomOptionsPanel.jsx` (capture logic + UI)
...
| Single image width | `imgW = 110` | 110mm | Size when only 1 view is captured |
| Multi image width | `imgW = 82` | 82mm each | Size when 2+ views (side by side) |
| Image gap | `gap = 6` | 6mm | Space between side-by-side images |
...
| Page break threshold | `y > 250` | 250mm | Auto page-break for 3+ images |
